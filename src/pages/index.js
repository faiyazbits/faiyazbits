...
const IndexPage = () => (
  <Layout>
    <Seo title="Home" />
    <section className="flex justify-center flex-col z-10 p-5 items-center">
      <div style={indexStyles.container}>
        ...
        <p
          style={indexStyles.subtext}
          className="text-gray-900 dark:text-white  text-base md:text-xl lg:text-2xl  font-mono leading-loose sm:leading-relaxed font-semibold"
        >
